            ...
            <tbody>
              ...
              >
                <td
                  ...
                  :class="
                    scoresbykeywords.results.totalScore < 40
                      ? 'orange--text'
                      : 'text-green-600'
                  "
                >
...
export default {
  ...
  methods: {
    ...
    async getReport() {
      ...
      const data = this.scoresbykeywords.map(row => ({
        Agente: Object.keys(row.recordingsSummary),
        Grabacion: Object.keys(row.recordingsSummary)
        // "Porcentaje promedio llamada" : row.recordingsSummary.totalScore,
      }));
